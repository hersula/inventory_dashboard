...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GET: () => (/* binding */ GET),\n/* harmony export */   POST: () => (/* binding */ POST)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n/* harmony import */ var _lib_prisma__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/lib/prisma */ \"(rsc)/./src/lib/prisma.ts\");\n/* harmony import */ var _lib_apiAuth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/lib/apiAuth */ \"(rsc)/./src/lib/apiAuth.ts\");\n/* harmony import */ var bcryptjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! bcryptjs */ \"(rsc)/./node_modules/bcryptjs/index.js\");\n/* harmony import */ var bcryptjs__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(bcryptjs__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var zod__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! zod */ \"(rsc)/./node_modules/zod/v3/types.js\");\n\n\n\n\n\nconst userSchema = zod__WEBPACK_IMPORTED_MODULE_4__.object({\n    name: zod__WEBPACK_IMPORTED_MODULE_4__.string().min(1),\n    email: zod__WEBPACK_IMPORTED_MODULE_4__.string().email(),\n    password: zod__WEBPACK_IMPORTED_MODULE_4__.string().min(6),\n    role: zod__WEBPACK_IMPORTED_MODULE_4__[\"enum\"]([\n        \"ADMIN\",\n        \"MANAGER\",\n        \"STAFF\"\n    ])\n});\nasync function GET() {\n    const { error, session } = await (0,_lib_apiAuth__WEBPACK_IMPORTED_MODULE_2__.requirePermission)(\"users.manage\");\n    if (error) return error;\n    const companyId = (0,_lib_apiAuth__WEBPACK_IMPORTED_MODULE_2__.getCompanyId)(session);\n    const users = await _lib_prisma__WEBPACK_IMPORTED_MODULE_1__.prisma.user.findMany({\n        where: {\n            companyId\n        },\n        select: {\n            id: true,\n            name: true,\n            email: true,\n            role: true,\n            active: true,\n            createdAt: true\n        },\n        orderBy: {\n            createdAt: \"desc\"\n        }\n    });\n    return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(users);\n}\nasync function POST(req) {\n    const { error, session } = await (0,_lib_apiAuth__WEBPACK_IMPORTED_MODULE_2__.requirePermission)(\"users.manage\");\n    if (error) return error;\n    const companyId = (0,_lib_apiAuth__WEBPACK_IMPORTED_MODULE_2__.getCompanyId)(session);\n    const body = await req.json();\n    const parsed = userSchema.safeParse(body);\n    if (!parsed.success) {\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            message: \"Data tidak valid\",\n            issues: parsed.error.issues\n        }, {\n            status: 400\n        });\n    }\n    // Email dipakai untuk login lintas-perusahaan (satu email = satu akun),\n    // jadi harus unik secara global, bukan hanya dalam satu perusahaan.\n    const existing = await _lib_prisma__WEBPACK_IMPORTED_MODULE_1__.prisma.user.findUnique({\n        where: {\n            email: parsed.data.email\n        }\n    });\n    if (existing) return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n        message: \"Email sudah terdaftar\"\n    }, {\n        status: 409\n    });\n    const hashed = await bcryptjs__WEBPACK_IMPORTED_MODULE_3___default().hash(parsed.data.password, 10);\n    const user = await _lib_prisma__WEBPACK_IMPORTED_MODULE_1__.prisma.user.create({\n        data: {\n            ...parsed.data,\n            password: hashed,\n            companyId\n        },\n        select: {\n            id: true,\n            name: true,\n            email: true,\n            role: true,\n            active: true,\n            createdAt: true\n        }\n    });\n    return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(user, {\n        status: 201\n    });\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./src/app/api/users/route.ts\n");
