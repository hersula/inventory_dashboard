...
const navItems: NavItem[] = [
  ...
  { href: "/stock-opname", label: "Stock Opname", icon: ClipboardCheck, permission: "opname.view", section: "Utama" },
  { href: "/laporan-stok", label: "Laporan Stok Barang", icon: History, permission: "barang.view", section: "Utama" },
